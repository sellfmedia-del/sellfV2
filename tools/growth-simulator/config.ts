...
export const sectors: SectorConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      f('salesCycleMonths', 'Satış döngüsü', 'Sales cycle', 1, 24, 1, 'months', true),
    ...
    baseline: {marketingSpend: 300000, cpl: 1500, nonPaidLeads: 120, qualificationRate: 35, proposalRate: 55, winRate: 25, averageDeal: 400000, deliveryCapacity: 18, revenueRecognitionRate: 60, existingRevenue: 2000000, deliveryCostRate: 45, salesCommissionRate: 0, salesCycleMonths: 3, salesPayroll: 500000, deliveryPayroll: 1050000, marketingOps: 200000, tech: 120000, otherFixed: 180000, growthInvestment: 0},
    scenario: {marketingSpend: 450000, cpl: 1500, nonPaidLeads: 120, qualificationRate: 38, proposalRate: 58, winRate: 27, averageDeal: 430000, deliveryCapacity: 22, revenueRecognitionRate: 60, existingRevenue: 2000000, deliveryCostRate: 45, salesCommissionRate: 0, salesCycleMonths: 3, salesPayroll: 600000, deliveryPayroll: 1200000, marketingOps: 250000, tech: 150000, otherFixed: 200000, growthInvestment: 500000},
  },
  {
