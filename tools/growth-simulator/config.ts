...
export const sectors: SectorConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      f('revenueRecognitionRate', 'Dönemde gelirleşme oranı', 'Revenue recognition rate', 0, 100, 1, 'percent'), f('existingRevenue', 'Mevcut müşteri geliri', 'Existing-customer revenue', 0, 100000000, 50000, 'currency'),
      f('deliveryCostRate', 'Teslimat maliyeti oranı', 'Delivery cost rate', 1, 90, 1, 'percent', true), f('salesCommissionRate', 'Satış komisyonu oranı', 'Sales commission rate', 0, 30, .5, 'percent', true),
      f('salesCycleMonths', 'Satış döngüsü', 'Sales cycle', 1, 24, 1, 'months', true), f('projectDurationMonths', 'Ortalama proje süresi', 'Average project duration', 1, 36, 1, 'months', true),
      ...
      f('growthInvestment', 'Tek seferlik büyüme yatırımı', 'One-off growth investment', 0, 100000000, 50000, 'currency', true),
    ],
    baseline: {marketingSpend: 300000, cpl: 1500, nonPaidLeads: 120, qualificationRate: 35, proposalRate: 55, winRate: 25, averageDeal: 400000, deliveryCapacity: 18, revenueRecognitionRate: 60, existingRevenue: 2000000, deliveryCostRate: 45, salesCommissionRate: 0, salesCycleMonths: 3, projectDurationMonths: 6, salesPayroll: 500000, deliveryPayroll: 1050000, marketingOps: 200000, tech: 120000, otherFixed: 180000, growthInvestment: 0},
    scenario: {marketingSpend: 450000, cpl: 1500, nonPaidLeads: 120, qualificationRate: 38, proposalRate: 58, winRate: 27, averageDeal: 430000, deliveryCapacity: 22, revenueRecognitionRate: 60, existingRevenue: 2000000, deliveryCostRate: 45, salesCommissionRate: 0, salesCycleMonths: 3, projectDurationMonths: 6, salesPayroll: 600000, deliveryPayroll: 1200000, marketingOps: 250000, tech: 150000, otherFixed: 200000, growthInvestment: 500000},
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      f('projectDurationMonths', 'Proje süresi', 'Project duration', 6, 60, 1, 'months', true), f('salesStartMonth', 'Satış başlangıç ayı', 'Sales start month', 1, 36, 1, 'months', true),
      f('monthlySalesRate', 'Aylık stok satış oranı', 'Monthly inventory sales rate', .5, 25, .5, 'percent', true), f('downPaymentRate', 'Peşinat oranı', 'Down-payment rate', 0, 100, 1, 'percent', true),
      f('collectionMonths', 'Kalan tahsilat süresi', 'Remaining collection period', 1, 60, 1, 'months', true), f('openingCash', 'Başlangıç nakdi', 'Opening cash', 0, 1000000000, 1000000, 'currency', true),
      f('annualFinanceRate', 'Yıllık finansman oranı', 'Annual finance rate', 0, 100, 1, 'percent', true),
    ],
    baseline: {sellableArea: 12000, pricePerSqm: 45000, discountRate: 0, constructionCostPerSqm: 20000, contingencyRate: 12, marketingSpend: 9000000, financeCost: 32000000, landCost: 100000000, softCosts: 18000000, salesCommissionRate: 3, overhead: 24000000, growthInitiative: 0, marketingAttributedRevenue: 90000000, projectDurationMonths: 24, salesStartMonth: 3, monthlySalesRate: 4, downPaymentRate: 30, collectionMonths: 12, openingCash: 50000000, annualFinanceRate: 36},
    scenario: {sellableArea: 12000, pricePerSqm: 48000, discountRate: 0, constructionCostPerSqm: 19500, contingencyRate: 10, marketingSpend: 12000000, financeCost: 24000000, landCost: 100000000, softCosts: 18000000, salesCommissionRate: 3, overhead: 24000000, growthInitiative: 3000000, marketingAttributedRevenue: 125000000, projectDurationMonths: 24, salesStartMonth: 3, monthlySalesRate: 5, downPaymentRate: 35, collectionMonths: 10, openingCash: 70000000, annualFinanceRate: 32},
  },
]
