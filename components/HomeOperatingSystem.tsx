...
const dict = {
  tr: {
    ...
    intro: "Gerçek büyümeyi anlamak, ölçmek ve uygulamak için tek bir sistem.",
    navStep: "Step by Step Metodolojisi",
    navMeasure: "BHS & RGI",
    navOperating: "Growth & Operations",
    leftEyebrow: "ÖLÇÜLEBİLEN BÜYÜME",
    leftTitleA: "Growth,",
    leftTitleB: "measured.",
    leftDesc: "Önce nerede olduğunuzu netleştirir, sonra gerçek büyümeyi kendi ölçüm sistemimizle takip ederiz.",
    ...
    dataLabel: "Veri odaklı",
    dataDesc: "Tahminleri azaltır. Ne işe yarıyorsa ona odaklanır.",
    baseline: "BASELINE",
    ...
    rightDesc: "Strateji ve execution aynı büyüme sistemi içinde birlikte çalışır — daha hızlı, daha akıllı ve daha verimli.",
    rightCta: "Operating Model'i İncele",
    growthTeam: "Growth Team",
    growthCount: "11 Danışman",
    growthSub: "Direction. Strategy. Governance.",
    growthItems: [
      "BHS'i ölçer, RGI'ı takip eder",
      "Strateji ve roadmap'i belirler",
      "Pazar ve rakip araştırmasını yönetir",
      "Execution ve performansı denetler",
      "Süreci Step by Step ile hizalar",
    ],
    ...
    opsItems: [
      ...
      "E-commerce, CRM ve daha fazlası",
    ],
