...
export default function Ecosystem() {
  ...
  return (
    <section className="home-ecosystem relative overflow-hidden bg-[#090b0b] text-white border-y border-white/[.07]">
            ...
            >
              ...
              <div className="relative flex h-full flex-col justify-between">
                <div>
                  ...
                  <p className="mt-6 max-w-[25ch] text-[15px] leading-[1.55] text-white/62">{brand.description[currentLang]}</p>
                </div>
